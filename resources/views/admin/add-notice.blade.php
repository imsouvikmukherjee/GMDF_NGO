                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                          ...
                          @endif
                            ...
                            <form action="{{route('add.notice.store')}}" method="POST">
                              @csrf

                                <div class="form-group">
                                  <label for="exampleInputEmail1"> Title</label>
                                  <input type="text" class="form-control" id="exampleInputEmail1" name="title" value="{{old('title')}}" aria-describedby="emailHelp"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="editor" rows="5" name="description" placeholder="Enter description " cols="7">{{old('description')}}</textarea>
