...
@Section('main-container')
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Upload Result</h1>
            ...
            <div class="col-xl-12 col-lg-12 mb-4">
              <div class="card">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between text-dark">
                    ...
                    <a href="{{route('school.result')}}" class=" btn btn-sm btn-light"><i class="bi bi-arrow-90deg-left"></i> Back</a>
                  ...
                  <div class="container">
                    <div class="row">
                        ...
                        @endif
                            ...
                            <form action="{{route('add.result.store')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="exampleFormControlSelect1" name="student">
                              ...
                              @foreach($studentlist as $students)
                                ...
                                <label for="">Upload Result (pdf)</label>
                                <div class="input-group mb-3">

                                  <input type="file" class="form-control" id="inputGroupFile02" name="resultdocument">
