...
@Section('main-container')
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Add Class | School</h1>
            ...
            <div class="col-xl-12 col-lg-12 mb-4">
              <div class="card">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between text-dark">
                    ...
                    <a href="{{route('school.class')}}" class=" btn btn-sm btn-light"><i class="bi bi-arrow-90deg-left"></i> Back</a>
                            ...
                            <form action="{{route('add.class.store')}}" method="POST">
                              ...
                              <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputEmail1" name="class" aria-describedby="emailHelp" placeholder="Enter class">
