              ...
              <div class="card">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between text-dark">
                  ...
                  @endif
                            ...
                            <form action="{{route('school.details.store')}}" method="POST" enctype="multipart/form-data">
                              @csrf
                              ...
                              <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                      <div class="form-group">
                                        <label for="fileInput2">Upload Logo (940 x 960)</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="editor" rows="5" name="about" placeholder="Enter about school " cols="7">{{old('about')}}</textarea>
                                  ...
                                  <div class="row">
                                    <div class="col-md-6">
                                      <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Enter email" name="email" value="{{old('email')}}" class="form-control" id="fileInput1" >
                                    ...
                                    <div class="col-md-6">
                                      <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Enter contact no." name="contact" value="{{old('contact')}}" class="form-control" id="fileInput2" >
                                  ...
                                  <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="address" placeholder="Enter school address">{{old('address')}}</textarea>
                                  </div>
