...
@Section('main-container')
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Update Sliders</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                          ...
                          @endif
                            ...
                            <form action="{{url('/admin/edit-slider-store')}}/{{encrypt($data->id)}}" method="POST" enctype="multipart/form-data">
                              @csrf
                                <div class="form-group">
                                  <label for="exampleInputEmail1">Slider Title</label>
                                  <input type="text" class="form-control" id="exampleInputEmail1" value="{{$data->title}}"  name="title" aria-describedby="emailHelp"
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" id="exampleInputEmail1"  value="{{$data->description}}" name="description" aria-describedby="emailHelp"
                                    placeholder="Enter description">
