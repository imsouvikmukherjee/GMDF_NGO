...
@Section('main-container')
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Add Teacher Credentials </h1>
                        ...
                        <div class="col-sm-8">
                            <form>
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" value="abc modern school" id="exampleInputEmail1" aria-describedby="emailHelp" readonly>
