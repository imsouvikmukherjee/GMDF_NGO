...
@Section('main-container')
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Update Notice | School</h1>
                  ...
                  <div class="container">
                    <div class="row">
                      ...
                      @endif
                            ...
                            <form action="{{url('/admin/school/edit-notice-store')}}/{{encrypt($data->id)}}" method="POST">
                              @csrf
                              ...
                              <div class="form-group">
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" id="exampleInputEmail1" value="{{$data->title}}" aria-describedby="emailHelp"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="editor" rows="5" placeholder="Enter description " cols="7" name="description">{{$data->description}}</textarea>
