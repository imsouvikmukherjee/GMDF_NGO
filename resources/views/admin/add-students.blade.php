        ...
        <div class="col-xl-12 col-lg-12 mb-4">
            <div class="card">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between text-dark">
                    ...
                    <a href="{{ route('school.students') }}" class=" btn btn-sm btn-light"><i
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                ...
                                <form action="{{ route('student.details.store') }}" method="POST"
                                        ...
                                        <select class="form-control" id="exampleFormControlSelect1" name="student_id">
                                            ...
                                            @foreach ($studentlist as $students)
                                                <option value="{{ $students->id }}"
                                                    {{ old('student') == $students->id ? 'selected' : '' }}>
                                                ...
                                                <select class="form-control" id="exampleFormControlSelect1" name="class">
                                                    ...
                                                    @foreach ($classdata as $class)
                                                        <option value="{{ $class->class }}"
                                                            {{ old('class') == $class->class ? 'selected' : '' }}>
                                                            {{ $class->class }}</option>
                                                    @endforeach
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date" value="{{ old('dateofbirth') }}"
                                                    placeholder="Enter name" name="dateofbirth" class="form-control"
                                                    id="fileInput1">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="fileInput2">Document of Student (Adhar / Pan / TC Certificate as
                                                    pdf)</label>
                                                <input type="file" placeholder="Enter email" name="documentofstudent"
                                                    class="form-control" id="fileInput2">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" placeholder="Enter guardian's name"
                                                    name="gurdiansname" value="{{ old('gurdiansname') }}"
                                                    class="form-control" id="fileInput1">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="fileInput2">Guardian's Contact No.</label>
                                                <input type="text" placeholder="Enter gurdian's no."
                                                    name="gurdianscontact" value="{{ old('gurdianscontact') }}"
                                                    class="form-control" id="fileInput2">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" placeholder="Enter guardian's name"
                                                    name="optionalcontact" value="{{ old('optionalcontact') }}"
                                                    class="form-control" id="fileInput1">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" placeholder="Enter gurdian's email"
                                                    name="gurdiansemail" value="{{ old('gurdiansemail') }}"
                                                    class="form-control" id="fileInput2">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="file" placeholder="Enter guardian's name"
                                                    name="studentpicture" class="form-control" id="fileInput1">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="fileInput2">Document of Parents (Adhar Card / Pan Card / Voter
                                                    ID as pdf)</label>
                                                <input type="file" placeholder="Enter email" name="documentofparent"
                                                    class="form-control" id="fileInput2">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" placeholder="Enter parmanent address" name="parmanentaddress"
                                            id="exampleFormControlTextarea1" rows="3">{{ old('parmanentaddress') }}</textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleFormControlTextarea1">Current Address</label>
                                        <textarea class="form-control" placeholder="Enter current address" name="currentaddress"
                                            id="exampleFormControlTextarea1" rows="3">{{ old('currentaddress') }}</textarea>
                                    </div>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="exampleFormControlSelect1"
                                                    ...
                                                    <option value="B-" {{ old('bloodgroup') == 'B-' ? 'selected' : '' }}>
                                                        B-</option>
                                                    <option value="AB+"
                                                        {{ old('bloodgroup') == 'AB+' ? 'selected' : '' }}>AB+</option>
                                                    <option value="AB-"
                                                        {{ old('bloodgroup') == 'AB-' ? 'selected' : '' }}>AB-</option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" placeholder="Enter email" name="rollno"
                                                    value="{{ old('rollno') }}" class="form-control" id="fileInput2">
                                            </div>
                                        </div>
                                    </div>
