...
@Section('main-container')
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Update Subject | School</h1>
                  ...
                  <div class="container">
                    <div class="row">
                      ...
                      @endif
                            ...
                            <form action="{{url('admin/school/update-subject-store')}}/{{encrypt($data->id)}}" method="POST">
                              @csrf
                        ...
                        <div class="form-group">
                          ...
                          <select class="form-control" id="exampleFormControlSelect1" name="teacher">
                            ...
                            <option value="{{$item->id}}" {{$data->teacher == $item->id? 'selected':''}}>{{$item->name}}</option>
                            @endforeach
                        ...
                        <div class="form-group">
                          ...
                          <select class="form-control" id="exampleFormControlSelect1" name="class">
                            ...
                            <option value="{{$item->id}}" {{$data->class == $item->id? 'selected':''}}>{{$item->class}}</option>
                           @endforeach
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                                    placeholder="Enter subject name" name="subject" value="{{$data->subject}}">
                                 
                                </div>

                                <div class="form-group">
                                    <label for="exampleFormControlTextarea1">Description</label>
                                    <textarea class="form-control" placeholder="Enter description" id="exampleFormControlTextarea1" rows="3" name="description">
